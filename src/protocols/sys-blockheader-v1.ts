...
/** Runtime representation used by the existing sys_blockheader_v1 protocol. */
export interface SysBlockHeaderV1 {
  hash: string;
  previousHash: string;
  createdAt: string;
  packer: string;
...
/**
 * Verify sys_blockheader_v1 with the behavior currently implemented by the
 ...
 */
export function verifyBlockHeaderV1(header: SysBlockHeaderV1): void {
